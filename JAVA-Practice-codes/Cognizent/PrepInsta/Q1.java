...
class Solution{
    ...
    Solution(double avg,double inUS){
        this.avg=avg;
        this.inUS=inUS;
...
public class Q1 {
    ...
    static Solution calculate(double ltr,double km){
       ...
       double avg=((ltr/km)*100);

       double distMines=(km*0.6214);
       double ltrGallon=(ltr*0.2642);

       double inUS=((distMines/ltrGallon)*1.00);


       return new Solution(avg, inUS);
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the liter :");
        double ltr=sc.nextInt();
